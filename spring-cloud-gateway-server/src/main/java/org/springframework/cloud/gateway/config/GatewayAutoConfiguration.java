...
public class GatewayAutoConfiguration {
	...
	/**
	 * PropertiesRouteDefinitionLocator是{@link RouteDefinitionLocator}的实现类 用于存储从配置文件中读取的路由定义信息
	...
	/**
	 *
	 * @param webHandler 上面装配的FilteringWebHandler
	 * @param routeLocator 上面装配的CachingRouteLocator
	...
	//读取配置文件中配置的RouteDefinition、FilterDefinition、PredicateDefinition并封装
	@Bean
